...
def get_args():
    ...
    parser.add_argument("--pretrained-model", type=str, default="/mnt/gs18/scratch/users/mhaskesn/coco_dataset/logs_serial/logs/trained_models/SSD.pth")
...
def test(opt):
    ...
    #Loading pretrained SSD weights
