...
class CocoDataset(CocoDetection):
    ...
    #create dictionary mapping for label ids and label names. Adds additional category 0:background
    ...
    #__getitem__ function to be called by dataloader
    # Input -> Image
    # Output -> Transformed and Normalized Image, Image_ID, (Height,Width) tuple, GT box locs, GT labels
